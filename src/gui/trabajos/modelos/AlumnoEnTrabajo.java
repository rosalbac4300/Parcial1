...
public class AlumnoEnTrabajo {
    ...
    public void mostrar(){
        System.out.println("Nombre: " + unAlumno.getApellido() + ", " + unAlumno.getNombre());
        System.out.println("CX : " + unAlumno.getCx());
        String dni = Integer.toString(unAlumno.getDni());
        System.out.println("DNI: " + dni);
        System.out.println("Trabaja en el proyecto desde: " + fechaDesde);
        if(fechaHasta != null){
            System.out.println("Dejo de trabajar en el proyecto: " + fechaHasta);
